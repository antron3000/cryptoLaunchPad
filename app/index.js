...
let persistentProvider = new ethers.providers.JsonRpcProvider('https://eth-rinkeby.alchemyapi.io/v2/Nj4dz0-UQClz9_FdK9JJkprxELVSMcc_')
...
const paidAddress = "0x171CE92CE1c6de201DCbAdeeC228DE6FF880b43a"//"0x0f54093364b396461AAdf85C015Db597AAb56203"//"0x92e52a1A235d9A103D970901066CE910AAceFD37"//"0x0fca8Fdb0FB115A33BAadEc6e7A141FFC1bC7d5a"
let paid
let paidPersistent
let decimals
let symbol
...
async function getBalance(){
  ...
  let balance = await paid.balanceOf(signer._address)
...
async function getApproved(){
	let approved = await paid.allowance(signer._address, paidPoolAddress)
...
async function approve() {
  ...
  await paid.approve(paidPoolAddress,amount)
}
